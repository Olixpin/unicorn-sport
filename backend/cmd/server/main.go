...
import (
	...
	_ "github.com/unicorn-sport/backend/docs" // swagger docs
)

// @title Unicorn Sport API
// @version 1.0.0
// @description API for Unicorn Sport - A platform connecting African football talent with scouts and agencies worldwide.
// @description
...
// @description - **player**: Football players looking for opportunities
// @description - **scout**: Scouts looking for talent
// @description - **admin**: Platform administrators

// @contact.name Unicorn Sport Support
// @contact.email support@unicornsport.com

// @license.name Proprietary
// @license.url https://unicornsport.africa/terms

// @host unicorn-sport-production.up.railway.app
// @BasePath /api/v1
...
func setupRouter(
	...
	// Serve OpenAPI spec (auto-generated by swag)
