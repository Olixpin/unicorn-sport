      ...
      <TransitionGroup name="toast">
        ...
        >
          ...
          <div class="ml-3 flex-1">
            <p class="text-sm font-medium text-neutral-900">{{ toast.title }}</p>
            <p v-if="toast.message" class="mt-1 text-sm text-neutral-500">{{ toast.message }}</p>
          </div>
          <button
            @click="remove(toast.id)"
            class="ml-4 flex-shrink-0 text-neutral-400 hover:text-neutral-600"
          >
