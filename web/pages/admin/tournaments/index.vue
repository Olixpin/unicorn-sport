  ...
  <div class="min-h-screen bg-neutral-50">
    ...
    <div class="bg-white border-b border-neutral-200 sticky top-0 z-10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-neutral-900">Tournaments</h1>
            <p class="text-neutral-500 mt-1">Manage tournaments and their match videos</p>
          </div>
          <button
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="tournaments.length === 0" class="text-center py-16">
        ...
        <h3 class="text-lg font-medium text-neutral-900 mb-2">No tournaments yet</h3>
        <p class="text-neutral-500 mb-6">Create your first tournament to start adding matches and videos</p>
        <button
          @click="showCreateModal = true"
        ...
        >
          ...
          <div class="p-5">
            ...
            <div class="flex items-center gap-4 mt-3 text-sm">
              ...
              <span v-if="tournament.location" class="flex items-center gap-1 text-neutral-500">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
